...
The documentation landing page (what is shown when you https://ibm-cloud.github.io/tf-ibm-docs/) presents the documentation for the latest version of the IBM Cloud Provider.
...
- `git` must be able to push to https://github.com/IBM-Cloud/tf-ibm-docs
